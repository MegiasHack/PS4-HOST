...
console.log("Servidor Web Activado En IPv4 con puerto 8080 en modo %s".green.bold, app.settings.env);
//Mostrar IPv4
localIpV4Address().then(function(ipAddress){
    console.log("Servidor: ".cyan.bold.underline + ipAddress.red.bold.underline + ":8080".red.bold.underline);
